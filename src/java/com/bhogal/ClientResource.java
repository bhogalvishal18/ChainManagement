...
@POST
    @Path("/getuserearning")
   @Produces(MediaType.APPLICATION_JSON)
  public String getuserearning(@FormParam("username") String username,
          @FormParam("session_id") String session,
          @FormParam("currentlevel") String currentlevel)
  {
   String result="";
  return  result;
  }
  @POST
    @Path("/insertlevelearning")
   @Produces(MediaType.APPLICATION_JSON)
  public String insertlevelearning(@FormParam("username") String username,
          @FormParam("session_id") String session,
          @FormParam("currentlevel") String currentlevel)
          
  {
    ...
    //result=obj.insert_Ear_Level(newmap, username, session, currentlevel);
         }catch(Exception e)
      {
          System.out.println(e.getMessage());
      }
